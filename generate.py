...
@media (max-width:768px) {{
  ...
  .m-product .inv-img {{ width:24px; height:24px; }}
  .m-info {{ min-width:0; }}
  .m-info .m-name {{ font-weight:600; font-size:10px; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; max-width:90px; }}
  .m-info .m-detail {{ font-size:8px; color:#636e72; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; max-width:90px; }}
