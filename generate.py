...
@media (max-width:768px) {{
  ...
  .inv-table .mobile-img {{ display:table-cell; padding:4px 2px; width:32px; vertical-align:middle; }}
  .inv-table .mobile-img .inv-img {{ width:32px; height:32px; }}
  .inv-table td.size-col {{ width:1%; white-space:nowrap; font-size:11px; padding:5px 3px 5px 0; }}
  .inv-table th.stock {{ width:36px; min-width:36px; max-width:36px; padding:5px 2px; font-size:9px; }}
  .inv-table td.stock {{ width:36px; min-width:36px; max-width:36px; padding:5px 2px; font-size:13px; }}
  ...
  .m-name {{ font-weight:600; font-size:12px; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; max-width:90px; }}
  .m-detail {{ font-size:10px; color:#999; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; max-width:90px; }}
